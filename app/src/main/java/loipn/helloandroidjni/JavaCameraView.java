...
//                    Size frameSize = calculateCameraFrameSize(sizes, new JavaCameraSizeAccessor(), width, height);
                    Camera.Size frameSize = sizes.get(5);
...
//                    mFrameChain[1] = new Mat(mFrameHeight + (mFrameHeight/2), mFrameWidth, CvType.CV_8UC1);
                    ...
                    myFrames = new MyFrame[2];
                    myFrames[0] = new MyFrame(new byte[size]);
                    myFrames[1] = new MyFrame(new byte[size]);
                    AllocateCache(mContext);
...
//            mFrameChain[mChainIdx].put(0, 0, frame);
            myFrames[mChainIdx].setFrame(frame);
...
//                        deliverAndDrawFrame(mCameraFrame[1 - mChainIdx]);
                    ...
                    deliverAndDrawFrame(mCamera, myFrames[1-mChainIdx]);
                }

//                long now = System.currentTimeMillis();
//                Log.e("deliverAndDrawFrame", (now - start) + " " + mFrameWidth + " " + mFrameHeight);
//                start = now;
            } while (!mStopThread);
